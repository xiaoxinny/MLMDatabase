...
export const HEADER_FONT = "'Manrope Variable', sans-serif";
  ...
  components: {
    ...
    MuiAppBar: {
      styleOverrides: {
        root: {
          boxShadow: 'none',
          backgroundColor: mode === 'light' ? PRIMARY_MAIN : '#000000' // optional
        }
      }
    }
  }
